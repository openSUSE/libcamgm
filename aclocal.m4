...
if test -z "$_PKG" ; then
  ...
  if test -f $_INP ; then
    ...
    # CHANGED: do not add any prefix on lower case names
    # echo "s/@%:@undef  *\\(@<:@m4_cr_letters@:>@\\)/@%:@undef $_LOW""_\\1/" >> _script
    echo "s/@%:@undef  *\\(@<:@m4_cr_letters@:>@\\)/@%:@undef \\1/" >> _script
    echo "s/@%:@def[]ine  *\\(@<:@m4_cr_LETTERS[]_@:>@@<:@_symbol@:>@*\\)\\(.*\\)/@%:@ifndef $_UPP""_\\1 \\" >> _script
    # CHANGED: avoid adding space char behind the name
    #echo "@%:@def[]ine $_UPP""_\\1 \\2 \\" >> _script
    echo "@%:@def[]ine $_UPP""_\\1\\2 \\" >> _script
    echo "@%:@endif/" >>_script
    # CHANGED: do not add any prefix on lower case names
    #          and avoid adding space char behind the name
    # echo "s/@%:@def[]ine  *\\(@<:@m4_cr_letters@:>@@<:@_symbol@:>@*\\)\\(.*\\)/@%:@ifndef $_LOW""_\\1 \\" >> _script
    # echo "@%:@define $_LOW""_\\1 \\2 \\" >> _script
    echo "s/@%:@def[]ine  *\\(@<:@m4_cr_letters@:>@@<:@_symbol@:>@*\\)\\(.*\\)/@%:@ifndef \\1 \\" >> _script
    echo "@%:@define \\1\\2 \\" >> _script
    echo "@%:@endif/" >> _script
