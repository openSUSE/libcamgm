...
limal::Logger logger("RevokeTest4");
    ...
    try {
        ...
        for(; dnit != dnl.end(); ++dnit) {
            ...
            if((*dnit).getType() == "countryName") {
                ...
                (*dnit).setRDNValue("Test Certificate for revocation 4");
            }
        ...
        CRLReason reason(CRLReason::CACompromise);
        reason.setCACompromiseDate(time(NULL)-1000);
        ...
        while(1) {
            ...
            blocxx::PerlRegEx r1("^R.+,CAkeyTime,[0-9]+Z\\t"+
                                 serial[1]+"\\t.*");
